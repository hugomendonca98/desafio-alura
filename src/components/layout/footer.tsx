    ...
    <footer>
      <div className="relative px-4 sm:px-8 lg:px-32 py-12 sm:py-16 flex flex-col lg:flex-row justify-between items-start gap-8">
        <div className="flex flex-col gap-3">
          ...
          <h3 className="font-chakra-petch font-bold text-secondary text-3xl sm:text-4xl lg:text-[60px] leading-none">
            Entre em contato
          </h3>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex gap-2 items-center">
            ...
            <a
              ...
              className="font-inter text-[#6e859f] text-sm sm:text-base hover:underline"
            >
          ...
          <div className="flex gap-2 items-center">
            ...
            <a
              href="#"
              className="font-inter text-[#6e859f] text-sm sm:text-base underline hover:no-underline"
            >
              /Fernanda Mascheti
            </a>
          </div>
      ...
      <div className="relative px-4 sm:px-8 lg:px-32 py-4">
        <p className="font-inter text-[#6e859f] text-sm sm:text-base text-center">
