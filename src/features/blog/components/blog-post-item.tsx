...
export function BlogPostItem() {
  return (
    <article className="bg-card border border-border rounded p-4 sm:p-6 flex flex-col gap-4 sm:gap-6 hover:shadow-[0px_4px_44px_0px_rgba(28,167,200,0.3)] transition-shadow">
      ...
      <h3 className="font-chakra-petch font-bold text-secondary dark:text-white text-lg sm:text-xl leading-none">
        Desenvolvendo uma ferramenta interativa de estudo
      </h3>
      <p className="font-inter text-muted-foreground text-sm sm:text-base leading-6">
